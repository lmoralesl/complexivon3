...
export const styles = StyleSheet.create({
  root: {
    ...
    backgroundColor: "#EAF4FBFF", // Fondo suave en tonos rojos
  },
  text: {
    fontSize: 25,
    fontWeight: "300",
    textAlign: "center",
    color: "#3F3DA3FF", // Rojo oscuro para mejor contraste
  },
  input: {
    width: "100%",
  ...
  button: {
    backgroundColor: "#2F3DD3FF", //  botones
    width: "100%",
    borderRadius: 14,
    marginVertical: 9,
    alignItems: "center",
  ...
  buttonSignOut: {
    backgroundColor: "#1C26B7FF", // azul más oscuro para Sign Out
    width: "50%",
    borderRadius: 14,
    alignItems: "center",
  },
  buttonEditProfile: {
    backgroundColor: "#2F3AD3FF", // azul fuerte para editar perfil
    width: "100%",
    borderRadius: 14,
    marginVertical: 9,
    alignItems: "center",
